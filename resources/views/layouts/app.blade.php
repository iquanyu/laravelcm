    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <main>
            ...
            @if (request()->routeIs('dashboard') || request()->routeIs('profile.show'))
                <div class="bg-white">
                    <div class="hidden space-x-8 sm:flex mx-auto max-w-screen-xl px-4 pt-12 sm:px-6 lg:px-8">
                        ...
                        <x-jet-nav-link href="{{ route('profile.show') }}"
                            :active="request()->routeIs('profile.show')" class="py-4">
                            {{ __('Profile') }}
                        </x-jet-nav-link>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 py-12 sm:px-12 lg:py-8 lg:px-8">
            <div class="px-6 py-6 bg-white rounded-lg md:py-12 md:px-12 lg:py-16 lg:px-16 xl:flex xl:items-center">
                ...
                <div class="mt-8 sm:w-full sm:max-w-md xl:mt-0 xl:ml-8">
                    <form class="sm:flex">
                        ...
                        <input id="email-address" name="email-address" type="email" autocomplete="email" required=""
                            class="w-full px-5 py-3 focus:ring-2 focus:ring-offset-2 rounded-md border border-gray-100 text-gray-900 bg-gray-50 placeholder-gray-500 focus:outline-none outline-none focus:placeholder-gray-400 transition duration-150 ease-in-out"
                            placeholder="Enter your email" />
                        <button type="submit"
                            class="mt-3 w-full flex items-center justify-center px-5 py-3 border border-transparent shadow text-base font-medium rounded-md text-white bg-orange-500 hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-700 focus:ring-white sm:mt-0 sm:ml-3 sm:w-auto sm:flex-shrink-0">
                            Notify me
                        </button>
                    </form>
        ...
        <div class="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
                <div class="md:max-w-md lg:col-span-2">
                    ...
                    <a href="{{ route('dashboard') }}" aria-label="Go home" title="Company"
